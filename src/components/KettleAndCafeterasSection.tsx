...
export const KettleAndCafeterasSection: React.FC = () => {
  return (
    <section className='  h-[30rem] flex  gap-6 '>
      <motion.div
        initial='hidden'
        whileInView='visible'
        viewport={{ once: true }}
        ...
        className=' w-full relative bg-interbrasGray rounded-[40px] overflow-hidden'
      >
        ...
        <div className=' absolute bottom-10 left-10'>
          <h2 className='text-5xl font-bold text-white'>Kettle</h2>
          <PrimaryButton
            className=' w-min'
            to='/kettle'
          />
      ...
      >        <img src='/home/KettleAndCafeterasSection/2.png' className='  h-[110%] top-1/2 -translate-y-[52%] absolute left-0' alt='kettle interbras' />
        ...
        <div className=' absolute bottom-10 right-10 '>
          <h2 className='text-5xl font-bold text-white'>Cafeteras</h2>
          <PrimaryButton
